    ...
    h1 {
     ...
     body {
      ...
      .subscription-button .btn {
         background-color: #08bd80; /* Black background */
      ...
      .home-category .title {
         color: #08bd80; /* Yellow text color */
         text-align: center;
      }
   ...
   .a{
    ...
    align-content: center;
      ...
      .box {
         ...
         margin: 10px;
         text-align: center;
         flex: 0 0 30%; /* Adjust this for desired width */
         border-radius: 10px;
      }

      .box a {
         background-color: #08bd80; /* Yellow background */
         color: black; /* Black text color */
         padding: 8px 16px;
         text-decoration: none;
         margin-top: 10px;
      ...
      .home-bg {
         ...
         background-image: url('project images/Untitled design (1).png');
      ...
      .center-button {
            display: flex;
            justify-content: center;
            align-items: center; /* Added to vertically center the button */
            margin-bottom: 20px;
            height: 100%; /* Added to make the button take full height */
        }
...
<section class="home-category">
   ...
   <h1 class="title">Enchanting cities covered by migraily</h1>
   <div class="box-container">
      <div class="box" >
         <a href="hyderbad.html"><img src="project images/main-qimg-062a1dce85280186b1c19b60185224f7-c.jpeg" alt=""></a>
         <h3>HYDERBAD</h3>
         <p></p>
         <a href="hyderbad.html" class="a">HYDERABAD</a>
      </div>

      <div class="box">
      
         <a href="nextpage2thane.html" ><img src="project images/thane city khetwal.JPG" alt=""></a>
         <h3>THANE</h3>
         <p></p>
         <a href="nextpage2thane.html" class="a">THANE</a>
      </div>

      <div class="box">
         <a href="pune.html"><img src="project images/R.jpeg" alt=""></a>
         <h3>PUNE</h3>
         <p></p>
         <a href="pune.html" class="a">PUNE</a>
      </div>
   </div>
</section>
<footer>
